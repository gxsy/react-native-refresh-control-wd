...
const RefreshControlExpand = createReactClass({
  ...
  propTypes: {
    ...
    /**
     * android
     * Called when the view pull enable
     */
    onPullEnable: PropTypes.func,
    /**
     * android
    ...
    /**
     * change default head view
     * type: ['test', 'default']
     */
    changeDefaultHead: PropTypes.string,
    /**
...
Other apis are consistent with official except "progressViewOffset"
  ...
  componentDidUpdate(prevProps: {refreshing: boolean, loadmore: boolean}) {
  ...
  render() {
    return (
      <NativeRefreshControl
        ...
        onPullDistance={this._onPullDistance}
        onPullEnable={this._onPullEnable}
      />
    );
  },
  ...
  _onPullDistance(event: Event) {
    if (!this.props.onPullDistance) {
      return;
    }
    this.props.onPullDistance(event.nativeEvent.distance);
  },

  _onPullEnable(event: Event) {
    if (!this.props.onPullEnable) {
      return;
    }
    this.props.onPullEnable(event.nativeEvent.enable);
  },
});
...
if (Platform.OS === 'ios') {
  ...
  var NativeRefreshControl = requireNativeComponent(
    'AndroidSuperSwipeRefreshLayout',
    RefreshControlExpand
  );
}

module.exports = RefreshControlExpand;
